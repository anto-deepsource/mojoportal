...
namespace mojoPortal.Web.Services
{
  ...
  //      private const string Columns4Over1Guid = "28ae8c68-b619-4e23-8dde-17d0a34ee7c6";
        ...
        {          
		    ...
		    var safeTemplates = new TinyMceTemplateCollection(collection).Templates;
		    foreach (var t in safeTemplates)
		    {
		    ...
		    context.Response.Write(JsonConvert.SerializeObject(safeTemplates));
